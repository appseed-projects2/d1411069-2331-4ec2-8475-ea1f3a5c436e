...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-31 15:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d1411069-2331-4ec2-8475-ea1f3a5c436e.git
$ cd d1411069-2331-4ec2-8475-ea1f3a5c436e
```
